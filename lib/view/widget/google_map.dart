...
Color whiteColor = Colors.white.withValues(alpha: 0.1);
        ...
        child: Row(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Icon(Icons.close, color: Colors.grey.shade400, size: 20.w),
            ),
          ],
        ),
      ),
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child:
                  Icon(Icons.close, color: AppColors.primaryLight, size: 14.w),
            ),
          ),
        ],
      ),
